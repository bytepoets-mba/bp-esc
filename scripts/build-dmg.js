...
const targetDmg = path.resolve(__dirname, `../target/release/bundle/dmg/${productName}_${version}_x64.dmg`);
const appPath = path.resolve(__dirname, `../target/release/bundle/macos/${productName}.app`);
